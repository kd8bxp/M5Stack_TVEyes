...
extern const unsigned char eyeupperleft2[];
extern const unsigned char eyeupperright2[];
extern const unsigned char eyelowerleft2[];
extern const unsigned char eyelowerright2[];

enum State { LEFT, CENTER, RIGHT } state;
...
void draweyes(void*) {
  ...
  if (random(0, 100) % 50 > 35 && state == RIGHT) {
    gfx_rca.pushImage(eye_x, eye_y, 88, 88,eyeupperright2);
    gfx_rca.pushImage(eye_x+100, eye_y, 88, 88, eyeupperright2);
    delay(250);
  }

  if (random(0, 100) % 50 > 35 && state == RIGHT) {
    gfx_rca.pushImage(eye_x, eye_y, 88, 88,eyelowerright2);
    gfx_rca.pushImage(eye_x+100, eye_y, 88, 88, eyelowerright2);
    delay(250);
  }

if (random(0, 100) % 50 > 35 && state == LEFT) {
    gfx_rca.pushImage(eye_x, eye_y, 88, 88,eyeupperleft2);
    gfx_rca.pushImage(eye_x+100, eye_y, 88, 88, eyeupperleft2);
    delay(250);
  }

  if (random(0, 100) % 50 > 35 && state == LEFT) {
    gfx_rca.pushImage(eye_x, eye_y, 88, 88,eyelowerleft2);
    gfx_rca.pushImage(eye_x+100, eye_y, 88, 88, eyelowerleft2);
    delay(250);
  }
  if (random(0,100) % 50 > 35 && state != CENTER) {
    if (state == RIGHT) {
  ...
  if (random(0,100) % 50 > 48 && state == CENTER) {
    state = RIGHT;
  gfx_rca.pushImage(eye_x, eye_y, 88,88, eyeright1);
  gfx_rca.pushImage(eye_x+100, eye_y, 88,88,eyeright1);
  delay(200);
...
if (random(0,100) % 50 > 47 && state == CENTER) {
...
for (int i=0; i<HORIZONTAL; i++) {
       ...
       randomSeed(random(0, readMicValue));
